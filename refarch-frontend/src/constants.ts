...
export const ROUTES_NOTIZENANSICHT = "Notizenansicht";
export const ROUTES_PERSOENLICHE_TODOS = "persoenliche_todos";
export const ROUTES_MIR_ZUGEWIESENE_TODOS = "mir_zugewiesene_todos";
export const ROUTES_ADMINVIEW = "adminview";
